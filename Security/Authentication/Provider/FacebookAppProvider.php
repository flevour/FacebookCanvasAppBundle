...
namespace Caefer\FacebookAppBundle\Security\Authentication\Provider;
...
class FacebookAppProvider implements AuthenticationProviderInterface
{
    /**
     * @var \Facebook
     */
    ...
    protected function createAuthenticatedToken($uid)
    {
        if (null === $this->userProvider) {
            ...
            return new FacebookAppToken($uid, $this->getFacebookPermissionsAsRoles($uid));
        }
    }
