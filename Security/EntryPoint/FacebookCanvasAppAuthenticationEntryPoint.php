...
namespace Caefer\FacebookCanvasAppBundle\Security\EntryPoint;
 ...
 */
class FacebookCanvasAppAuthenticationEntryPoint implements AuthenticationEntryPointInterface
{
    private $facebook;
    private $map;
    private $kernel;
